pipeline {
    ...
    stages {
	 ...
	 stage ('Upload Reports to Defect Dojo Api') {
			...
			sh 'python3 dojo_ci_cd.py --product=1 --file "/home/bharath/Documents/trufflehog.xml" --scanner="trufflehog scan" --high=0 --host=http://localhost:8000 --api_key=af2ab35a1b0cb933bbeb726c698596b58d23eb07 --user=admin'
		    }
	    }
